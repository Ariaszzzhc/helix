...
impl menu::Item for CompletionItem {
    ...
    fn format(&self, theme: &Self::Data) -> menu::Row {
        ...
        let style = match self {
            CompletionItem::Lsp(LspCompletionItem { item, .. }) => match item.kind {
                Some(lsp::CompletionItemKind::TEXT) => theme.try_get("ui.text"),
                Some(lsp::CompletionItemKind::METHOD) => theme.try_get("function.method"),
                Some(lsp::CompletionItemKind::FUNCTION) => theme.try_get("function"),
                Some(lsp::CompletionItemKind::CONSTRUCTOR) => theme.try_get("constructor"),
                Some(lsp::CompletionItemKind::FIELD) => theme.try_get("variable.other.member"),
                Some(lsp::CompletionItemKind::VARIABLE) => theme.try_get("variable"),
                Some(lsp::CompletionItemKind::CLASS) => theme.try_get("type.class"),
                Some(lsp::CompletionItemKind::INTERFACE) => theme.try_get("type.interface"),
                Some(lsp::CompletionItemKind::MODULE) => theme.try_get("namespace"),
                Some(lsp::CompletionItemKind::PROPERTY) => theme.try_get("variable.other.member"),
                Some(lsp::CompletionItemKind::UNIT) => theme.try_get(""),
                Some(lsp::CompletionItemKind::VALUE) => theme.try_get("variable"),
                Some(lsp::CompletionItemKind::ENUM) => theme.try_get("type.enum"),
                Some(lsp::CompletionItemKind::KEYWORD) => theme.try_get("keyword"),
                Some(lsp::CompletionItemKind::SNIPPET) => None,
                Some(lsp::CompletionItemKind::COLOR) => None,
                Some(lsp::CompletionItemKind::FILE) => None,
                Some(lsp::CompletionItemKind::REFERENCE) => None,
                Some(lsp::CompletionItemKind::FOLDER) => None,
                Some(lsp::CompletionItemKind::ENUM_MEMBER) => None,
                Some(lsp::CompletionItemKind::CONSTANT) => theme.try_get("constant"),
                Some(lsp::CompletionItemKind::STRUCT) => theme.try_get("type.struct"),
                Some(lsp::CompletionItemKind::EVENT) => None,
                Some(lsp::CompletionItemKind::OPERATOR) => theme.try_get("operator"),
                Some(lsp::CompletionItemKind::TYPE_PARAMETER) => None,
                Some(_kind) => None,
                None => None,
            },
            CompletionItem::Other(core::CompletionItem { .. }) => None,
        }
        .map_or(Style::default(), |style| {
        ...
        menu::Row::new([menu::Cell::from(kind), menu::Cell::from(label)])
    }
}
